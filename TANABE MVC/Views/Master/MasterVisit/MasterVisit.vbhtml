...
<div class="panel-content">
    <table class="table">
        <tr><td class="title-form" style="text-align: center; font-weight: bold;" colspan="3">:: MASTER VISIT ::</td></tr>
        <tr>
            <td class="cell-blank"></td>
            <td class="cell-reset cell-backround">
                @Using (Html.BeginForm("ExportTo", "MasterVisit"))
        ...
        <tr>
            @Html.Action("ViewMasterVisit", "MasterVisit")
        </tr>
    </table>
</div>
