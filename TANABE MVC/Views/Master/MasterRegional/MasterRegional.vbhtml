...
<div class="panel-content">
    <table class="table">
        <tr><td class="title-form" style="text-align: center; font-weight: bold;" colspan="3">:: MASTER REGIONAL ::</td></tr>
        <tr>
            <td class="cell-blank"></td>
            <td class="cell-reset cell-backround">
                @Using (Html.BeginForm("ExportTo", "MasterRegional"))
        ...
        <tr>
            @Html.Action("ViewMasterRegional", "MasterRegional")
        </tr>
    </table>
</div>
