@Html.DevExpress().PopupControl(
    Sub(settings)
            ...
            settings.SetContent(Sub()
                                        ...
                                        Dim gridLookup = Html.DevExpress().GridLookup(
                                            Sub(glp)
                                                    glp.Name = "GridLookup"
                                                    glp.Width = 240
                                                    ...
                                                    glp.GridViewClientSideEvents.SelectionChanged = "selected_doctors"
                                                    ...
                                                    glp.GridViewProperties.SetStatusBarTemplateContent(Sub(c)
                                                                                                               ...
                                                                                                               ViewContext.Writer.Write("<table style='width:100%'><tr><td style='width:80%'><div style='overflow: hidden'><div style='padding: 3px; float: left;'>")

                                                                                                               Html.DevExpress().Label(Sub(lbl)
                                                                                                                                               lbl.Name = "lblSelected"
                                                                                                                                               lbl.PreRender = Sub(sender, e)
                                                                                                                                                                       Dim lb As ASPxLabel = DirectCast(sender, ASPxLabel)
                                                                                                                                                                       lb.ClientInstanceName = "lblSelected"
                                                                                                                                                               End Sub
                                                                                                                                       End Sub).GetHtml()
                                                                                                               ViewContext.Writer.Write("</div></td><td>")
                                                                                                               ViewContext.Writer.Write("<div style='overflow: hidden'><div style='padding: 3px; float: right;'width:20%'>")
                                                                                                               ...
                                                                                                               ViewContext.Writer.Write("</div></td></tr></table>")
...
<script type="text/javascript">
    ...
    function setdateplan() {
        ...
        if (dp == null || dp == '' || dp == 'undefined') {
            alert('Please choose your date plan');
            return DateEdit1.Focus();
        }
        var day = dp.getDate();
        ...
        if (vdr_code == null || vdr_code == '' || vdr_code == 'undefined') {
            alert('Please Choose your dr code for first');
            return GridLookup.Focus();
        }
        popupControl.Hide();
        var param = 'addvisit;' + vdr_code + ";" + vdate;
