...
@Html.DevExpress().PopupControl(Sub(settings)
                                    ...
                                    settings.SetContent(Sub()
                                                            ...
                                                            Html.DevExpress().PageControl(Sub(tb)
                                                                                              ...
                                                                                              tb.ClientSideEvents.ActiveTabChanged = "tab_selected"
                                                                                              tb.EnableClientSideAPI = True
...
<script type="text/javascript">
    ...
    function submit_edit() {
        ...
        var visited = rdVisitedDoctorVisit.GetValue();       
        var info = txtinfoDoctorVisit.GetValue();
        var sp = txtspDoctorVisit.GetValue();
        var sp_value = spvalueDoctorVisit.GetValue();

        var param = 'save_edit-'+ visited + '-'+ info +'-'+ sp+'-'+sp_value;
