@Html.DevExpress().GridView(Sub(settings)
                                settings.Name = "detailGrid_" + ViewData("visit_id")
                                settings.SettingsDetail.MasterGridName = "grid"
                                     settings.CallbackRouteValues = New With {Key .Controller = "VerRealHistory", Key .Action = "MasterDetailPartial", Key .visit_id = ViewData("visit_id")}
