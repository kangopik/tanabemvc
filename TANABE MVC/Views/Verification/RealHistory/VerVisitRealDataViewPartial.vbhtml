@Html.DevExpress().GridView(Sub(settings)
                                ...
                                settings.CallbackRouteValues = New With {.Controller = "VerRealHistory", .Action = "DataViewPartial"}
                                settings.CustomActionRouteValues = New With {.Controller = "VerRealHistory", .Action = "DataViewPartialCustomCallback"}
                                                         ...
                                                         column.SetDataItemTemplateContent(
                                                             Sub(c)
                                                                 ...
                                                                 Html.DevExpress().Button(Sub(btnVerify)
                                                                                              btnVerify.Name = "btnUnVerify_" + c.KeyValue.ToString()
