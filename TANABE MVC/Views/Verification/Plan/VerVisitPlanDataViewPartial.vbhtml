@Html.DevExpress().GridView(
    Sub(settings)
            ...
            settings.CustomActionRouteValues = New With {.Controller = "VerVisitplan", .Action = "DataViewPartialCustomCallback"}
            ...
            settings.Columns(6).Width = 150
            settings.Columns(10).Width = 200
