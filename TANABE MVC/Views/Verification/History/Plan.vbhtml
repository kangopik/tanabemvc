...
<script type="text/javascript">
    ...
    function Unverify_Grid(s, e) {
        ...
        if (confirm("Are you sure want to verify this plan with code " + visit_id + " ?") == true) {
            DataView1.PerformCallback({ prm: param });
        }
    }
</script>
...
<div class="panel-content">
    <table class="table">
        <tr><td class="title-form">VERIFICATION PLAN HISTORY </td></tr>
        <tr>
            <td class="cell-newlan cell-backround distance-left">
                @Html.Action("GridLookupPartial", "VerPlanHistory")
            </td>
        ...
        <tr>
            @Html.Action("DataViewPartial", "VerPlanHistory")
...
<script type="text/javascript">
    ...
    function OnEndCallback(s, e) {
        ...
        if (s.cpUnVerifyFeedback != 'undefined') {
            if (s.cpVerifyFeedback == 'success_unverify') {
                alert('Visit plans have been unverified');
                s.cpUnVerifyFeedback = "undefined";
            } else if (s.cpUnVerifyFeedback == 'error_unverify') {
                alert('Visit plans unverification failed');
