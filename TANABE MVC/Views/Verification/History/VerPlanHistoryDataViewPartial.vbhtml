@Html.DevExpress().GridView(Sub(settings)
                                ...
                                settings.CallbackRouteValues = New With {.Controller = "VerPlanHistory", .Action = "DataViewPartial"}
                                settings.CustomActionRouteValues = New With {.Controller = "VerPlanHistory", .Action = "DataViewPartialCustomCallback"}
                                ...
                                settings.Columns.Add(Sub(column)
                                                         ...
                                                         column.SetDataItemTemplateContent(Sub(c)
                                                                                               ...
                                                                                               Html.DevExpress().Button(Sub(btnVerify)
                                                                                                                            ...
                                                                                                                            btnVerify.ClientSideEvents.Click = "Unverify_Grid"
                                                                                                                            'TANABE_MVC.GlobalClass.temp_ver_visit_plan_visit_id = c.KeyValue.ToString()
                                                                                                                            btnVerify.ToolTip = "UnVerify " & c.KeyValue.ToString()
                                                                                                                        End Sub).Render()
                                ...
                                settings.Columns(4).Caption = "VER PLAN"
                                settings.Columns(5).Caption = "VER REAL"

                                settings.Columns(6).Caption = "SP"
                                settings.Columns(7).Caption = "SP VALUE"

                                settings.Columns(8).Caption = "STATUS"
                                ...
                                settings.Columns(7).Visible = False
                                settings.Columns(8).Visible = False
                                ...
                                settings.CustomJSProperties = Sub(s, e)
                                                                  If ViewData("UnVerifyFlag") IsNot Nothing Then
                                                                      e.Properties("cpUnVerifyFeedback") = ViewData("UnVerifyFlag").ToString()
                                                                  End If
