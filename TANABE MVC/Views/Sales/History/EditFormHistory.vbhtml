@Html.DevExpress().GridView(Sub(setting)
                                setting.Name = "gridEditProductSalesHistory"
                                setting.KeyFieldName = "spa_id"
                                setting.Width = Unit.Percentage(100)
                                setting.CallbackRouteValues = New With {.Controller = "SalesHistory", .Action = "DetailEditForm"}
                                     setting.SettingsEditing.AddNewRowRouteValues = New With {.Controller = "SalesHistory", .Action = "AddProduct", .spa_date = ViewData("spa_date"), .spa_quantity = ViewData("spa_quantity"), .spa_note = ViewData("spa_note")}
                                     setting.SettingsEditing.DeleteRowRouteValues = New With {.Controller = "SalesHistory", .Action = "DeleteProduct", .spa_id = ViewData("spa_id")}
                                     setting.SettingsEditing.UpdateRowRouteValues = New With {.Controller = "SalesHistory", .Action = "UpdateProduct", .spa_id = ViewData("spa_id"), .spa_date = ViewData("spa_date"), .spa_quantity = ViewData("spa_quantity"), .spa_note = ViewData("spa_note")}
                                ...
                                setting.CommandColumn.SetHeaderCaptionTemplateContent(Sub(tmp)
                                                                                          ...
                                                                                          Html.DevExpress().Button(Sub(button)
                                                                                                                       ...
                                                                                                                       button.ClientSideEvents.Click = "function (s, e) { gridEditProductSalesHistory.AddNewRow(); }"
                                                                                                                   End Sub).GetHtml()
