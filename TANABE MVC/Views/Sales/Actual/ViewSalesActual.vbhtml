@Html.DevExpress().GridView(Sub(grid)
                                ...
                                grid.SettingsEditing.DeleteRowRouteValues = New With {.Controller = "SalesActual", .Action = "DeleteActual", .sales_id = ViewData("sales_id")}
                                grid.SettingsEditing.UpdateRowRouteValues = New With {.Controller = "SalesActual", .Action = "UpdateActual"}
                                grid.ClientSideEvents.EndCallback = "gridSalesActual_EndCallBack"
                                ...
                                grid.SetDetailRowTemplateContent(Sub(c)
                                                                     ...
                                                                     Html.DevExpress().PageControl(Sub(p)
                                                                                                       ...
                                                                                                       p.TabPages.Add(Sub(tb)
                                                                                                                          ...
                                                                                                                          tb.SetContent(Sub()
                                                                                                                                            Html.RenderAction("DetailSalesActual", New With {Key .sp_id = DataBinder.Eval(c.DataItem, "sp_id")})
                                                                                                                                        End Sub)
                                                                                                                      End Sub)
                                                                                                   End Sub).GetHtml()
                                ...
                                grid.SetEditFormTemplateContent(Sub(c)
                                                                    ...
                                                                    Html.DevExpress().Button(Sub(btns)
                                                                                                 ...
                                                                                                 btns.ClientSideEvents.Click = "function (s, e) { gridSalesActual.UpdateEdit(s, e); }"
                                                                                             End Sub).GetHtml()
                                                                    ViewContext.Writer.Write("</div>")
                                                                    ...
                                                                    Html.DevExpress().Button(Sub(btnf)
                                                                                                 btnf.Text = "Finish"
                                                                                                 btnf.Name = "btnfinish"
                                                                                                 btnf.ClientSideEvents.Click = "function (s, e) { gridSalesActual.CancelEdit(s,e); }"
                                                                                             End Sub).GetHtml()
                                                                    ViewContext.Writer.Write("</div>")
                                                                End Sub)
