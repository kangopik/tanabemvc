@Html.DevExpress().GridView(Sub(setting)
                                ...
                                setting.CallbackRouteValues = New With {.Controller = "SalesActual", .Action = "DetailEditForm"}
                                     setting.SettingsEditing.AddNewRowRouteValues = New With {.Controller = "SalesActual", .Action = "AddProduct", .spa_date = ViewData("spa_date"), .spa_quantity = ViewData("spa_quantity"), .spa_note = ViewData("spa_note")}
                                     setting.SettingsEditing.DeleteRowRouteValues = New With {.Controller = "SalesActual", .Action = "DeleteProduct", .spa_id = ViewData("spa_id")}
                                     setting.SettingsEditing.UpdateRowRouteValues = New With {.Controller = "SalesActual", .Action = "UpdateProduct", .spa_id = ViewData("spa_id"), .spa_date = ViewData("spa_date"), .spa_quantity = ViewData("spa_quantity"), .spa_note = ViewData("spa_note")}
