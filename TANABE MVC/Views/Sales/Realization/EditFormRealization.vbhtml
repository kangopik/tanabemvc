@Html.DevExpress().GridView(Sub(setting)
                                ...
                                setting.CallbackRouteValues = New With {.Controller = "SalesRealization", .Action = "DetailEditForm"}
                                setting.SettingsEditing.AddNewRowRouteValues = New With {.Controller = "SalesRealization", .Action = "AddProduct", .spa_date = ViewData("spa_date"), .spa_quantity = ViewData("spa_quantity"), .spa_note = ViewData("spa_note")}
                                setting.SettingsEditing.DeleteRowRouteValues = New With {.Controller = "SalesRealization", .Action = "DeleteProduct", .spa_id = ViewData("spa_id")}
                                setting.SettingsEditing.UpdateRowRouteValues = New With {.Controller = "SalesRealization", .Action = "UpdateProduct", .spa_id = ViewData("spa_id"), .spa_date = ViewData("spa_date"), .spa_quantity = ViewData("spa_quantity"), .spa_note = ViewData("spa_note")}
