...
<script type="text/javascript">
    ...
    function gridSalesRealization_EndCallBack(s, e) {
        if (s.cpInsertResult != "undefined") {
            if (s.cpInsertResult == "success_on_generate") {
                ...
                gridSalesRealization.PerformCallback("reset" + ';' + null + ';' + null);
                s.cpInsertResult = "undefined";
            }
        }
...
<div class="panel-content">
    <table class="table">
        <tr>
            <td class="title-form" style="text-align: center; font-weight: bold;" colspan="7">:: SALES REALIZATION ::</td>
        </tr>
        <tr>
            ...
            <td class="cell-reset cell-backround">
                @Using (Html.BeginForm("ExportTo", "SalesRealization"))
                    @Html.DevExpress().Button(Sub(settings)
                                                  settings.Name = "PDF"
                                                  settings.ControlStyle.CssClass = "button"
        ...
        <tr>
            @Html.Action("ViewSalesRealization", "SalesRealization")
        </tr>
    </table>
</div>

@Html.Partial("~/Views/Sales/Realization/PopupMapping.vbhtml")