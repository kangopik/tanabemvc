@Html.DevExpress().GridView(Sub(grid)
                                ...
                                secondCC.ButtonRenderMode = GridCommandButtonRenderMode.Button
                                ...
                                grid.SetDetailRowTemplateContent(Sub(c)
                                                                     ...
                                                                     Html.DevExpress().PageControl(Sub(p)
                                                                                                       ...
                                                                                                       p.TabPages.Add(Sub(tb)
                                                                                                                          ...
                                                                                                                          tb.SetContent(Sub()
                                                                                                                                            Html.RenderAction("DetailSalesRealization", New With {Key .sp_id = DataBinder.Eval(c.DataItem, "sp_id")})
                                                                                                                                        End Sub)
                                                                                                                      End Sub)
                                                                                                   End Sub).GetHtml()
                                ...
                                grid.SetEditFormTemplateContent(Sub(c)
                                                                    ...
                                                                    Html.DevExpress().Button(Sub(btns)
                                                                                                 ...
                                                                                                 btns.ClientSideEvents.Click = "function (s, e) { gridSalesRealization.UpdateEdit(s, e); }"
                                                                                             End Sub).GetHtml()
                                                                    ViewContext.Writer.Write("</div>")
                                                                    ...
                                                                    Html.DevExpress().Button(Sub(btnf)
                                                                                                 btnf.Text = "Finish"
                                                                                                 btnf.Name = "btnfinish"
                                                                                                 btnf.ClientSideEvents.Click = "function (s, e) { gridSalesRealization.CancelEdit(s,e); }"
                                                                                             End Sub).GetHtml()
                                                                    ViewContext.Writer.Write("</div>")
                                                                End Sub)
                                ...
                                grid.CommandButtonInitialize = Sub(s, e)
                                                                   If e.VisibleIndex = -1 Then
                                                                       Return
                                                                   End If
                                                                   Dim EditButtonVisibleCriteria As Object = (TryCast(s, MVCxGridView)).GetRowValues(e.VisibleIndex, "sales_realization")
                                                                   Select Case e.ButtonType
                                                                       Case ColumnCommandButtonType.Edit
                                                                           If EditButtonVisibleCriteria = 0 Or IsDBNull(EditButtonVisibleCriteria = True) Then
                                                                               e.Text = "Realization"
                                                                           Else
                                                                               e.Text = "Edit"
                                                                           End If
