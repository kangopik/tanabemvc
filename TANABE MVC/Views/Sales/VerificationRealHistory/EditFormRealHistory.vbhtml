@Html.DevExpress().GridView(Sub(setting)
                                ...
                                setting.Width = Unit.Percentage(100)
                                     setting.CallbackRouteValues = New With {.Controller = "SalesRealHistoryVerification", .Action = "DetailEditForm"}
                                     setting.SettingsEditing.AddNewRowRouteValues = New With {.Controller = "SalesRealHistoryVerification", .Action = "AddProduct", .spa_date = ViewData("spa_date"), .spa_quantity = ViewData("spa_quantity"), .spa_note = ViewData("spa_note")}
                                     setting.SettingsEditing.DeleteRowRouteValues = New With {.Controller = "SalesRealHistoryVerification", .Action = "DeleteProduct", .spa_id = ViewData("spa_id")}
                                     setting.SettingsEditing.UpdateRowRouteValues = New With {.Controller = "SalesRealHistoryVerification", .Action = "UpdateProduct", .spa_id = ViewData("spa_id"), .spa_date = ViewData("spa_date"), .spa_quantity = ViewData("spa_quantity"), .spa_note = ViewData("spa_note")}
