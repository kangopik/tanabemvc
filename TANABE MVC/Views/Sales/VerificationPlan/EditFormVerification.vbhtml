@Html.DevExpress().GridView(Sub(setting)
                                ...
                                setting.CallbackRouteValues = New With {.Controller = "SalesPlanVerification", .Action = "DetailEditForm"}
                                setting.SettingsEditing.AddNewRowRouteValues = New With {.Controller = "SalesPlanVerification", .Action = "AddProduct", .prd_code = ViewData("cbProductLookup.GetValue()"), .tx_target_qty = ViewData("tx_target_qty"), .tx_note = ViewData("tx_note")}
                                setting.SettingsEditing.DeleteRowRouteValues = New With {.Controller = "SalesPlanVerification", .Action = "DeleteProduct", .sp_id = ViewData("sp_id")}
                                ...
                                setting.SetEditFormTemplateContent(Sub(e)
                                                                       ...
                                                                       Html.DevExpress().ComboBox(Sub(cmb)
                                                                                                  ...
                                                                                                  End Sub).BindList(TANABE_MVC.SalesPlanVerificationController.cbProductLookup).GetHtml()
                                                                       ViewContext.Writer.Write("</td>")
