@Html.DevExpress().GridView(Sub(grid)
                                grid.Name = "gridSalesRealVerification"
                                grid.CallbackRouteValues = New With {.Controller = "SalesRealVerification", .Action = "ViewSalesRealVerification"}
                                grid.CustomActionRouteValues = New With {.Controller = "SalesRealVerification", .Action = "ViewSalesRealVerificationCustomCallback"}
                                grid.SettingsEditing.DeleteRowRouteValues = New With {.Controller = "SalesRealVerification", .Action = "DeleteVerification", .sales_id = ViewData("sales_id")}
                                grid.SettingsEditing.UpdateRowRouteValues = New With {.Controller = "SalesRealVerification", .Action = "UpdateVerification"}
                                grid.ClientSideEvents.EndCallback = "gridSalesRealVerification_EndCallBack"
                                ...
                                grid.Columns.Add(Sub(c)
                                                     ...
                                                     c.SetDataItemTemplateContent(Sub(s)
                                                                                      ...
                                                                                      Html.DevExpress().Button(Sub(btnVerify)
                                                                                                                   ...
                                                                                                                   btnVerify.ToolTip = "Verify " & s.KeyValue.ToString()
                                                                                                               End Sub).Render()
                                                                                  End Sub)
                                                 End Sub)
                                ...
                                grid.SetDetailRowTemplateContent(Sub(c)
                                                                     ...
                                                                     Html.DevExpress().PageControl(Sub(p)
                                                                                                       ...
                                                                                                       p.TabPages.Add(Sub(tb)
                                                                                                                          ...
                                                                                                                          tb.SetContent(Sub()
                                                                                                                                            Html.RenderAction("DetailSalesRealVerification", New With {Key .sp_id = DataBinder.Eval(c.DataItem, "sp_id")})
                                                                                                                                        End Sub)
                                                                                                                      End Sub)
                                                                                                   End Sub).GetHtml()
                                ...
                                grid.SetEditFormTemplateContent(Sub(c)
                                                                    ...
                                                                    Html.DevExpress().Button(Sub(btns)
                                                                                                 ...
                                                                                                 btns.ClientSideEvents.Click = "function (s, e) { gridSalesRealVerification.UpdateEdit(s, e); }"
                                                                                             End Sub).GetHtml()
                                                                    ViewContext.Writer.Write("</div>")
                                                                    ...
                                                                    Html.DevExpress().Button(Sub(btnf)
                                                                                                 btnf.Text = "Finish"
                                                                                                 btnf.Name = "btnfinish"
                                                                                                 btnf.ClientSideEvents.Click = "function (s, e) { gridSalesRealVerification.CancelEdit(s,e); }"
                                                                                             End Sub).GetHtml()
                                                                    ViewContext.Writer.Write("</div>")
                                                                End Sub)
