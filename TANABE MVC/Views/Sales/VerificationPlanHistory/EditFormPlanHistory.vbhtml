@Html.DevExpress().GridView(Sub(setting)
                                ...
                                setting.CallbackRouteValues = New With {.Controller = "SalesPlanHistoryVerification", .Action = "DetailEditForm"}
                                     setting.SettingsEditing.AddNewRowRouteValues = New With {.Controller = "SalesPlanHistoryVerification", .Action = "AddProduct", .prd_code = ViewData("cbProductLookup.GetValue()"), .tx_target_qty = ViewData("tx_target_qty"), .tx_note = ViewData("tx_note")}
                                setting.SettingsEditing.DeleteRowRouteValues = New With {.Controller = "SalesPlanHistoryVerification", .Action = "DeleteProduct", .sp_id = ViewData("sp_id")}
