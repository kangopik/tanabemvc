...
<script type="text/javascript">
    ...
    function do_export(s, e) {
        ...
        VisitProductPivotRep.PerformCallback({ act: param });
    }
    ...
    <table style="width:100%;">
        <tr>
            <td style="padding-top:0px;vertical-align:top;">
                @Html.Action("VisitProductPivotRepPartialView", Model)
                @*@Html.Action("VisitOnlyPivotRepPartialView", "rptVisitOnlyPivotRep")*@
            </td>
            <td style="width:250px">
                @Html.DevExpress().PivotCustomizationExtension(TANABE_MVC.PivotGridLayout.VisitProductPivotGridSettings).GetHtml()
            </td>
        </tr>
    </table>
</div>
