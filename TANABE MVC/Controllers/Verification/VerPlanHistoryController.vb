...
Public Class VerPlanHistoryController
    Inherits Controller
    Dim repo As New r_VerPlanHistory
    ...
    Function Index() As ActionResult
        ...
        Else
            ...
            Return View("~/Views/Verification/History/Plan.vbhtml")
        End If
    ...
    Public Function DataViewPartial() As ActionResult
        ...
        Try
            ...
            model = repo.GetVisitPlanVerified(rep_id, Session("sess_month"), Session("sess_year"))
        Catch generatedExceptionName As Exception
            Throw
        End Try
        Return PartialView("~/Views/Verification/History/VerPlanHistoryDataViewPartial.vbhtml", model)
    End Function
    ...
    Public Function DataViewPartialCustomCallback(ByVal prm As String) As ActionResult
        ...
        ElseIf act = "export" Then
            Return RedirectToAction("exportto", "VerPlanHistory", New With {.export_type = params(1)})
        Else
            Dim visit_id As String = params(4)
    ...
    Public Function GridLookupPartial() As ActionResult
        ...
        Catch generatedExceptionName As Exception
            Throw
        End Try
        Return PartialView("~/Views/Verification/History/GridLookupPartial.vbhtml", model)
    End Function
    ...
    Public Function ExportTo(ByVal export_type As String) As ActionResult
        ...
        Select Case export_type.ToUpper()
            Case "CSV"
                Return GridViewExtension.ExportToCsv(VerPlanHistoryGridViewHelper.ExportGridViewSettings, model)
            Case "PDF"
                Return GridViewExtension.ExportToPdf(VerPlanHistoryGridViewHelper.ExportGridViewSettings, model)
            Case "RTF"
                Return GridViewExtension.ExportToRtf(VerPlanHistoryGridViewHelper.ExportGridViewSettings, model)
            Case "XLS"
                Return GridViewExtension.ExportToXls(VerPlanHistoryGridViewHelper.ExportGridViewSettings, model)
            Case "XLSX"
                Return GridViewExtension.ExportToXlsx(VerPlanHistoryGridViewHelper.ExportGridViewSettings, model)
            Case Else
...
Public NotInheritable Class VerPlanHistoryGridViewHelper
    ...
    Private Shared Function CreateExportGridViewSettings() As GridViewSettings
        ...
        settings.Name = "VER_PLAN_HISTORY"
        settings.CallbackRouteValues = New With {Key .Controller = "verplanhistory", Key .Action = "Index"}

        settings.SettingsExport.ReportHeader = "PT. TANABE INDONESIA"
        settings.SettingsExport.PaperKind = PaperKind.A4
        settings.SettingsExport.FileName = "ver_plan_history_" & _user_name & "_" & Now.ToString("ddMMyyyy HH:mm:ss")
        ...
        settings.SettingsText.Title = "VERIFICATION PLAN HISTORY"
