...
Public Class SalesRealizationController
    Inherits Controller

    Dim repo As New ISalesRealization()
    ...
    Function Index() As ActionResult
        ...
        Else
            ...
            Return View("~/Views/Sales/Realization/SalesRealization.vbhtml")
        End If
    End Function

    <ValidateInput(False)> _
    Public Function ViewSalesRealization() As ActionResult
        Dim rep_id As String = TryCast(Session("rep_id"), [String])
        Try
            ...
            End If
            Return PartialView("~/Views/Sales/Realization/ViewSalesRealization.vbhtml", model)
    ...
    <ValidateInput(False)> _
    Public Function ViewSalesRealizationCustomCallback(ByVal prm As String) As ActionResult
        Dim rep_id As String = TryCast(Session("rep_id"), [String])
    ...
    <ValidateInput(False)> _
    Public Function DetailSalesRealization(ByVal sp_id As String) As ActionResult
        ...
        Return PartialView("~/Views/Sales/Realization/DetailSalesRealization.vbhtml", model)
    End Function
    ...
    Public Function ViewEditForm(ByVal sp_id As String) As ActionResult
        ...
        Catch generatedExceptionName As Exception
            Throw
        End Try
        Return PartialView("~/Views/Sales/Realization/EditFormRealization.vbhtml", model)
    End Function
    ...
    Function DeleteReal(ByVal coll As FormCollection) As ActionResult
    ...
    <HttpPost(), ValidateInput(False)> _
    Function UpdateReal() As ActionResult
        Dim rep_id As String = TryCast(Session("rep_id"), [String])
        Dim model
        repo.UpdateFake()
        Try
...
#Region "Export"
    ...
    Private Function CreateExportGridViewSettings() As GridViewSettings
        ...
        settings.Name = "gridSalesRealization"
        settings.CallbackRouteValues = New With {Key .Controller = "SalesRealization", Key .Action = "ViewSalesRealization"}
        ...
        settings.SettingsExport.FileName = "sales_realization_" & _user_name & "_" & Now.ToString("ddMMyyyy HH:mm:ss")
        ...
        settings.Columns(3).Caption = "SPEC."
        settings.Columns(4).Caption = "DR. QUADRANT"
        settings.Columns(5).Caption = "DR. MONITORING"
        settings.Columns(6).Caption = "PRODUCT. NAME"
