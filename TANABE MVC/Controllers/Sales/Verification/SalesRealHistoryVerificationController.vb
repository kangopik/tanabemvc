...
Public Class SalesRealHistoryVerificationController
    Inherits Controller

    Dim repo As New ISalesRealVerficationHistory()
    ...
    Function Index() As ActionResult
        ...
        Else
            ...
            Return View("~/Views/Sales/VerificationRealHistory/SalesRealHistoryVerification.vbhtml")
        End If
    End Function

    <ValidateInput(False)> _
    Public Function ViewSalesRealHistory() As ActionResult
        Dim model
        Try
        ...
        Catch ex As Exception
            Throw
        End Try
        Return PartialView("~/Views/Sales/VerificationRealHistory/ViewSalesRealHistoryVerification.vbhtml", model)
    End Function

    <ValidateInput(False)> _
    Public Function ViewSalesRealHistoryCustomCallback(ByVal prm As String) As ActionResult
    ...
    <ValidateInput(False)> _
    Public Function DetailSalesRealHistory(ByVal sp_id As String) As ActionResult
        ...
        Return PartialView("~/Views/Sales/VerificationRealHistory/DetailSalesRealHistory.vbhtml", model)
    End Function
    ...
    Public Function ViewEditForm(ByVal sp_id As String) As ActionResult
        ...
        Catch generatedExceptionName As Exception
            Throw
        End Try
        Return PartialView("~/Views/Sales/VerificationRealHistory/EditFormRealHistory.vbhtml", model)
    End Function
    ...
    Public Shared Function dsRep()
        Dim rep = New ISalesRealVerficationHistory()
        Dim mdl = rep.dsRep()
        Return mdl
    End Function
    ...
    Public Function ExportTo(ByVal OutputFormat As String) As ActionResult
        Dim model = Nothing
        Try
            Dim repo = New ISalesRealVerficationHistory()
            Dim rep_id As String = TryCast(Session("rep_id_selection"), [String])
            model = repo.dsProductSales(rep_id, Session("sess_month"), Session("sess_year"))
        Catch ex As Exception
            Throw ex
...
#Region "Export"
    ...
    Private Function CreateExportGridViewSettings() As GridViewSettings
        ...
        tempPageMSG.Append("SALES REAL VERIFICATION HISTORY" & vbCrLf)
        ...
        settings.Name = "gridSalesRealHistoryVerification"
        settings.CallbackRouteValues = New With {Key .Controller = "SalesRealHistoryVerification", Key .Action = "ViewSalesRealHistoryVerification"}
        ...
        settings.SettingsExport.FileName = "sales_real_history_verification_" & _user_name & "_" & Now.ToString("ddMMyyyy HH:mm:ss")
