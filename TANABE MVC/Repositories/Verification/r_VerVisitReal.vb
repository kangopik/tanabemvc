...
Namespace Repositories
    Public Class r_VerVisitReal
        ...
        Public Function GetVisitRealReady(ByVal rep_id As String, ByVal month As String, ByVal year As String) As List(Of VerVisitRealModel)
            Try
                ...
                param.Add("@year", year)
                myConnection.Open()
                Dim tb = SqlMapper.Query(Of VerVisitRealModel)(myConnection, "SP_SELECT_VISIT_REAL_READY", param, commandType:=CommandType.StoredProcedure)
                Return tb.ToList()
        ...
        Function processVerify(ByVal visit_id As String, ByVal nik As String) As Boolean
            ...
            Try
                ...
                For i As Integer = 0 To v_visit_id.Length - 1
                    ...
                    Dim cmd As New SqlCommand("[SP_VERIFICATION_VISIT_REAL]", myConnection)
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.Parameters.AddWithValue("@visit_id", pVisitId)
                    cmd.Parameters.AddWithValue("@visit_real_verification_by", nik)
                    cmd.Parameters.AddWithValue("@visit_real_verification_date", date_now)
