...
Namespace Repositories
    Public Class ISalesRealVerification
        ...
        Public Function VerificationSalesReal(ByVal sales_id As String, ByVal sales_plan_verification_by As String) As Boolean
            Try
                Dim date_now As Date = CDate(DateTime.Now())
                Dim param As DynamicParameters = New DynamicParameters()
                param.Add("@sales_id", sales_id)
                param.Add("@sales_real_verification_by", sales_plan_verification_by)
                param.Add("@sales_real_verification_date", date_now)
                connection()
                con.Open()
                con.Execute("SP_VERIFICATION_SALES_REAL", param, commandType:=CommandType.StoredProcedure)
                Return True
            Catch ex As Exception
                Throw ex
                Return False
