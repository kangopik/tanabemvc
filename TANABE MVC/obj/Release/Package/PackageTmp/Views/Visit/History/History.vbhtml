...
<script type="text/javascript">
    function OnClick(s, e) {
        ...
        $.ajax({
            type: "POST",
            url: '@Url.Action("ExportTo", "visithistory")',
        ...
        <tr>
            <td class="cell-month cell-backround">
                @Html.DevExpress().TextBox(Sub(settings)
                                               settings.Name = "txtsearch"
                                               settings.Properties.NullText = "Enter text to search..."
                ...
                @Using (Html.BeginForm("retrieve", "visithistory", method:=FormMethod.Post))
...
End Using
            ...
            <td class="cell-reset cell-backround">
                @Using (Html.BeginForm("reset", "visithistory", method:=FormMethod.Post))
                    @Html.DevExpress().Button(Sub(settings)
            ...
            <td class="cell-reset cell-backround">
                @Using (Html.BeginForm("ExportTo", "visithistory", method:=FormMethod.Post))
                    @Html.DevExpress().Button(Sub(settings)
...
@*@Html.Partial("~/Views/Visit/_PopupNewPlanView.vbhtml")*@
