    ...
    @Html.DevExpress().NavBar(Sub(settings)
                                  ...
                                  If rep_position = "RM" Or rep_position = "AM" Then
                                      settings.Groups.Add(Sub(group)
                                                              ...
                                                              group.Items.Add("Visit Realization History", "vervisitrealhistory", "~/Content/Images/check.png")
                                                              group.Items(3).NavigateUrl = "/vervisithistory"
