@Html.DevExpress().GridView(Sub(settings)
                                ...
                                settings.CallbackRouteValues = New With {.Controller = "VerVisitplan", .Action = "DataViewPartial"}
                                ...
                                'settings.CommandColumn.SelectAllCheckboxMode = 1 'page
                                                                          
                                'settings.CommandColumn.SelectAllCheckboxMode = GridViewSelectAllCheckBoxMode.AllPages 'ALL DATA 2
                                'settings.CommandColumn.SelectAllCheckboxMode = GridViewSelectAllCheckBoxMode.Page 'PER PAGE
                                ...
                                settings.Columns.Add(Sub(column)
                                                         ...
                                                         column.SetDataItemTemplateContent(Sub(c)
                                                                                               ...
                                                                                               Html.DevExpress().Button(Sub(btnVerify)
                                                                                                                            ...
                                                                                                                            btnVerify.ClientSideEvents.Click = "VerifyPartial"
                                ...
                                settings.Columns(10).Caption = "MONITORING"
                                settings.Columns(11).Caption = "DK/LK"
                                settings.Columns(12).Caption = "AREA MIS"
                                settings.Columns(13).Caption = "CATEGORY"
                                settings.Columns(14).Caption = "CHANNEL"
