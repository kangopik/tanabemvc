...
Public Class VerPlanHistoryModel

    Public m_visit_id As String
    Public m_rep_id As String
    Public m_visit_date_plan As DateTime
    Public m_visit_plan As Integer
    Public m_visit_realization As Integer
    ...
    Public m_visit_date_realization_saved As DateTime
    Public m_visit_date_plan_saved As DateTime
    Public m_visit_date_plan_updated As DateTime
    Public m_visit_info As String
    Public m_visit_sp As String

    Public m_visit_sp_value As Double
    Public m_visit_plan_verification_status As Integer
    Public m_visit_plan_verification_by As String
    Public m_visit_plan_verification_date As DateTime
    Public m_visit_real_verification_status As Integer

    Public m_visit_real_verification_by As String
    Public m_visit_real_verification_date As DateTime
